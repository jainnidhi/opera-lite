...
<?php } ?>
    ...
    <div class="footer-wrap clearfix">
        ...
        <?php if (get_theme_mod('opera_footer_footer_text') == '') { ?>
            <div class="smallprint">
                <p>
                    <a href="<?php $opera_theme = wp_get_theme(); echo $opera_theme->get( 'ThemeURI' ); ?>">
                        <?php _e('Opera WordPress theme by IdeaBox', 'opera'); ?>
                    </a>
                </p>
            </div>
        <?php } else { ?>   
                    <div class="smallprint"><?php echo wpautop(esc_html(get_theme_mod('opera_footer_footer_text'))); ?></div>
        <?php } ?> 
